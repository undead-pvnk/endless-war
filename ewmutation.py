...
class EwMutation:
    ...
    def __init__(self, id_user=None, id_server=None, id_mutation=None):
        ...
        if (id_user != None) and (id_server != None) and (id_mutation != None):
            ...
            try:
                ...
                # Retrieve object
                cursor.execute(
                    "SELECT {data}, {mutation_counter} FROM mutations WHERE id_user = %s AND id_server = %s AND {id_mutation} = %s".format(
    ...
    def persist(self):
        ...
        try:
            ...
            # Save the object.
            cursor.execute(
                "REPLACE INTO mutations(id_user, id_server, {id_mutation}, {data}, {mutation_counter}) VALUES(%s, %s, %s, %s, %s)".format(
                    id_mutation=ewcfg.col_id_mutation,
                    data=ewcfg.col_mutation_data,
                    mutation_counter=ewcfg.col_mutation_counter
                ), (
