...
async def take(cmd):
	...
	item_sought = ewitem.find_item(item_search = item_search, id_user = poi.community_chest, id_server = cmd.message.guild.id if cmd.message.server is not None else None)
