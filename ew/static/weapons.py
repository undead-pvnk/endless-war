...
weapon_list = [
    ...
    EwWeapon(  # 32
        ...
        str_kill="{name_player} plants their pitchfork firmly into {name_target} and lifts them high into the air. After {name_target} loses consciousness, {name_player} throws them to the ground.",
