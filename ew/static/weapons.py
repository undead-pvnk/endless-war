...
weapon_list = [
    ...
    EwWeapon(  # 32
        ...
        str_kill="{name_player} plants their pitchfork firmly into {name_target} and lifts them high into the air. After {name_target} loses consciousness, their balls explode in {name_player}'s mouth with the force of an overdue party poppepper.",
