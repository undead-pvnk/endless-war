...
poi_list = [
    ...
    EwPoi(
        ...
        neighbors = {'downtown': 20, 'downtownstreetf': 20, 'downtownstreetb': 20, 'smogsburgstreetd': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "downtown",
        neighbors = {'downtown': 20, 'downtownstreetd': 20, 'downtownstreetf': 20, 'krakbaystreeta': 20, 'downtownsubwaystation': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "krakbay",
        neighbors = {'krakbay': 20, 'krakbaystreetd': 20, 'krakbaystreetf': 20, 'northsleezeboroughstreeta': 20},
    ...
    EwPoi(
        ...
        neighbors = {'oozegardens': 20, 'oozegardensstreetd': 20, 'oozegardensstreetb': 20, 'southsleezeboroughstreetd': 20, 'southoutskirtsedge': 60},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "oozegardens",
        neighbors = {'oozegardens': 20, 'oozegardensstreeta': 20, 'oozegardensstreetc': 20, 'krakbaystreetc': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "oozegardens",
        neighbors = {'oozegardens': 20, 'oozegardensstreetb': 20, 'oozegardensstreetd': 20, 'poudrinalleystreetd': 20, 'oozegardensfarms': 20},
    ...
    EwPoi(
        ...
        neighbors = {'glocksbury': 20, 'glocksburystreete': 20, 'glocksburystreetb': 20, 'krakbaystreetf': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "glocksbury",
        neighbors = {'glocksbury': 20, 'glocksburystreetd': 20, 'glocksburystreeta': 20, 'northsleezeboroughstreete': 20},
    ...
    EwPoi(
        ...
        neighbors = {'jaywalkerplain': 20, 'jaywalkerplainstreete': 20, 'jaywalkerplainstreetb': 20, 'northsleezeboroughstreetd': 20, 'jaywalkerplainsubwaystation': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "jaywalkerplain",
        neighbors = {'jaywalkerplain': 20, 'jaywalkerplainstreeta': 20, 'jaywalkerplainstreetc': 20, 'jaywalkerplainsubwaystation': 20},
    ...
    EwPoi(
        ...
        alias = ['hangemsquare', 'hangem', 'hang', "hang-'emsquare", 'hand-emsquare', "hang-'em", 'hang-em'],
        ...
        is_street = True,
        father_district = "dreadford",
        neighbors = {'dreadford': 20, 'dreadfordstreeta': 20, 'southwestoutskirtsedge': 60, 'dreadfordblimptower': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "vandalpark",
        neighbors = {'vandalpark': 20, 'vandalparkstreetb': 20, 'vandalparkstreetd': 20, 'gatlingsdalestreetb': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "vandalpark",
        neighbors = {'vandalpark': 20, 'vandalparkstreetc': 20, 'vandalparkstreeta': 20, 'poloniumhillstreete': 20},
    ...
    EwPoi(
        ...
        neighbors = {'poloniumhill': 20, 'poloniumhillstreete': 20, 'poloniumhillstreetb': 20, 'gatlingsdalestreetc': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "poloniumhill",
        neighbors = {'poloniumhill': 20, 'poloniumhillstreeta': 20, 'poloniumhillstreetc': 20, 'toxingtonstreetb': 20},
        wikipage = "https://rfck.miraheze.org/wiki/Polonium_Hill#Curie_Highschool",
    ),
    EwPoi(
        id_poi = "poloniumhillstreetc",
        alias = ['gellerpoint', 'geller'],
        str_name = "Geller Point",
        str_desc = "You stand at the top of a grassy, starry hill that overlooks the endless desert to the west. Geller Point is a nice place to relax, but as usual, you can expect the locals of Polonium Hill to ruin everything. They all insist to death that aliens and paranormal activity flock here to observe their boring community and probe their depressing little middle-class buttholes. You've never seen any yourself, but their words always put you a little on edge. If you squint your eyes just right, you think you can see Area 51 in the distance. Nah, that can't be right. This street connects back into Polonium Hill. This street is connected to Curie Highschool, Sawdust Lumberyard, and Veterans Center.",
        channel = "geller-point",
        major_role = "poloniumhill_major",
        minor_role = "poloniumhillstreetc_minor",
        permissions = {'poloniumhillstreetc': ['read', 'send', 'connect']},
        property_class = "b",
        is_street = True,
        father_district = "poloniumhill",
        neighbors = {'poloniumhill': 20, 'poloniumhillstreetb': 20, 'poloniumhillstreetd': 20, 'charcoalparkstreetb': 20, 'westoutskirtsedge': 60},
        wikipage = "https://rfck.miraheze.org/wiki/Polonium_Hill#Geller_Point",
    ),
    EwPoi(
    ...
    EwPoi(
        ...
        neighbors = {'charcoalpark': 20, 'charcoalparkstreetb': 20, 'toxingtonstreetc': 20, 'northwestoutskirtsedge': 60},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "charcoalpark",
        neighbors = {'charcoalpark': 20, 'charcoalparkstreeta': 20, 'poloniumhillstreetc': 20, 'northwestoutskirtsedge': 60},
    ...
    EwPoi(
        ...
        neighbors = {'gatlingsdale': 20, 'gatlingsdalestreete': 20, 'gatlingsdalestreetb': 20, 'copkilltown': 20, 'gatlingsdalesubwaystation': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "gatlingsdale",
        neighbors = {'gatlingsdale': 20, 'gatlingsdalestreetc': 20, 'gatlingsdalestreete': 20, 'toxingtonstreeta': 20},
        wikipage = "https://rfck.miraheze.org/wiki/Gatlingsdale#NLACU_Institute_of_Slimeology",
    ),
    EwPoi(
        id_poi = "gatlingsdalestreete",
        alias = ['sludgeberrystreet', 'sludgeberry'],
        str_name = "Sludgeberry Street",
        str_desc = "This atmosphere of this street even when empty always gives you the sense of being full and having somewhere to be. Shops and small businesses seemingly stacked on top of each other all call out trying to catch your attention. Standing tall above the precariously stacked businesses are large brick buildings with ornate moldings decorating them. This street connects back into Gatlingsdale. This street is connected to The Garage, N.L.A.C.U. Institute of Slimeology, and 85th Street.",
        channel = "sludgeberry-street",
        major_role = "gatlingsdale_major",
        minor_role = "gatlingsdalestreete_minor",
        permissions = {'gatlingsdalestreete': ['read', 'send', 'connect']},
        property_class = "a",
        is_street = True,
        father_district = "gatlingsdale",
        neighbors = {'gatlingsdale': 20, 'gatlingsdalestreetd': 20, 'gatlingsdalestreeta': 20, 'astatineheightsstreeta': 20},
        wikipage = "https://rfck.miraheze.org/wiki/Gatlingsdale#Sludgeberry_Street",
    ),
    EwPoi(
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "astatineheights",
        neighbors = {'astatineheights': 20, 'astatineheightsstreete': 20, 'astatineheightsstreeta': 20, 'copkilltown': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "smogsburg",
        neighbors = {'smogsburg': 20, 'smogsburgstreetb': 20, 'smogsburgstreetd': 20, 'copkilltown': 20, 'smogsburgsubwaystation': 20},
        wikipage = "https://rfck.miraheze.org/wiki/Smogsburg#Company_Town_Square",
    ),
    EwPoi(
        id_poi = "smogsburgstreetd",
        alias = ['sludgerefinery', 'sludge'],
        str_name = "Sludge Refinery",
        str_desc = "This sprawling industrial process plant has the unenviable task of converting the crude sludge from the city's harbor into slime. You have no idea how that's accomplished or why this place looks like it was designed for tactical espionage action. This street connects back into Smogsburg. This street is connected to North End, Company Town Square, and Factory Row.",
        channel = "sludge-refinery",
        major_role = "smogsburg_major",
        minor_role = "smogsburgstreetd_minor",
        permissions = {'smogsburgstreetd': ['read', 'send', 'connect']},
        property_class = "b",
        is_street = True,
        father_district = "smogsburg",
        neighbors = {'smogsburg': 20, 'smogsburgstreetc': 20, 'smogsburgstreete': 20, 'downtownstreeta': 20},
        wikipage = "https://rfck.miraheze.org/wiki/Smogsburg#Sludge_Refinery",
    ),
    EwPoi(
        ...
        is_street = True,
        father_district = "smogsburg",
        neighbors = {'smogsburg': 20, 'smogsburgstreetd': 20, 'smogsburgstreeta': 20, 'oldnewyonkersstreeta': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "arsonbrook",
        neighbors = {'arsonbrook': 20, 'arsonbrookstreeta': 20, 'arsonbrookstreetc': 20, 'astatineheightsstreetd': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "arsonbrook",
        neighbors = {'arsonbrook': 20, 'arsonbrookstreetd': 20, 'arsonbrookstreeta': 20, 'littlechernobylstreeta': 20, 'arsonbrookfarms': 20},
    ...
    EwPoi(
        ...
        neighbors = {'maimridge': 20, 'maimridgestreetc': 20, 'maimridgestreetb': 20, 'astatineheightsstreetc': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "maimridge",
        neighbors = {'maimridge': 20, 'maimridgestreeta': 20, 'maimridgestreetc': 20, 'arsonbrookstreetc': 20, 'northwestoutskirtsedge': 60},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "maimridge",
        neighbors = {'maimridge': 20, 'maimridgestreetb': 20, 'maimridgestreeta': 20, 'toxingtonstreetd': 20, 'northwestoutskirtsedge': 60},
    ...
    EwPoi(
        ...
        neighbors = {'brawlden': 20, 'brawldenstreetd': 20, 'brawldenstreetb': 20, 'arsonbrookstreetd': 20, 'northoutskirtsedge': 60},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "littlechernobyl",
        neighbors = {'littlechernobyl': 20, 'littlechernobylstreeta': 20, 'littlechernobylstreetc': 20, 'brawldenstreetd': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "oldnewyonkers",
        neighbors = {'oldnewyonkers': 20, 'oldnewyonkersstreetd': 20, 'oldnewyonkersstreeta': 20, 'vagrantscornerstreete': 20},
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "greenlightdistrict",
        neighbors = {'greenlightdistrict': 20, 'greenlightdistrictstreetb': 20, 'greenlightdistrictstreeta': 20, 'downtownstreetb': 20, 'greenlightsubwaystation': 20},
    ...
    EwPoi(
        ...
        str_desc = "A series of reedy creeks interspersed with quiet farms and burnt, black trees. Its overcast skies make the embers from frequent forest fires glow even brighter by comparison. Its soil is fertile with copious amounts of soot and accompanying nutrients.\n\nThree Gankers have set up a booth! Zeamaize seems to be dutifully taking dried party poppeppers from juveniles while Aloe rides on her, occasionally scribbling down notes on a clipboard. Meanwhile, the Beekeeper seems to have a cart to hand items to loyal partygoers. Sadly, their bees are stinging everyone in sight, so not many juveniles have reedemed their points.\n\nExits into Arsonbrook.",
