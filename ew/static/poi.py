...
poi_list = [
    ...
    EwPoi(
        ...
        is_street = True,
        father_district = "astatineheights",
        neighbors = {'astatineheights': 20, 'astatineheightsstreetb': 20, 'astatineheightsstreetd': 20},
    ...
    EwPoi(
        id_poi = "limecorp1f",
        alias = ['limecorp1f', '1f', 'lc1f', 'floor1', 'limecorpfloor1', 'limecorp', 'limes', 'lime'],
