...
help_responses = {
    ...
    "weather": "The weather of NLACakaNM can have certain outcomes on gameplay, most notably in regards to mutations like Light As A Feather or Airlock. To check the weather, use **'!weather'**.",
...
mutation_descriptions = {
    ...
    mutation_id_webbedfeet: "Your scavenging power increases the more slime there is in a district. Caps out at 400% more slime gained from scavenging, but does stack with the Airlock mutation. You can feel out the amount of slime you scavenge.",
    ...
    mutation_id_airlock: "Combined effects of Light as a Feather and the now-deprecated White Nationalist. This mutation is mutually exclusive with Light as a Feather. You also gain passive hunger when it's sunny, fire immunity in rain, and crit bonuses in the fog.",
    ...
    mutation_id_stiltwalker: "You can !jump. Like, for **REAL** dude. You can reach the blimp from the ground.",
