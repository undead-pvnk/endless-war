...
furniture_list = [
    ...
    EwFurniture(
        id_furniture = "customrug",
        str_name = "{custom} rug",
        str_desc = "A rug with {custom} on it.",
        rarity = "Plebeian",
        acquisition = "bartering",
        price = 1600000,
        vendors = ['bazaar'],
        furniture_place_desc = "You throw down and kick the rug to stretch along the ground.",
        furniture_look_desc = "You have a rug with a {custom} design.",
    ),
    EwFurniture(
        id_furniture = "customwallpaper",
        str_name = "{custom} wallpaper",
        str_desc = "It's wallpaper with {custom} all over it.",
        rarity = "Plebeian",
        acquisition = "bartering",
        price = 2400000,
        vendors = ['bazaar'],
        furniture_place_desc = "You meticulously glue the wallpaper onto the wall.",
        furniture_look_desc = "Your walls are decorated with {custom}.",
    ),
    EwFurniture(
