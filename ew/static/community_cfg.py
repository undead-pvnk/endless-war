...
skatetricks = [
    ...
    "You pass by doing a Noseslide grind! Someone's showing off!",
    ...
    "You glide across the floor with a Manual! Watch out, you run into someone!",
    ...
    "You get some major air and do successfully manage to pull off The 900! HOLY SHITBALLS!",
