...
food_list = [
    ...
    EwFood(
        ...
        str_desc = "It's an aushuck cooked until soft, and then filled with a delicious cole salad. Finally, it is then chilled to give a crisp taste. Tastes great with anything that will overpower the original flavor!",
    ...
    EwFood(
        ...
        vendors = ['Country Club'],
        str_eat = "You mentally prepare yourself before taking a heaping spoonful. The flavor is both rank and flavorless, with the consistency seems to morph in your mouth with every chew. The dollop of cream ontop helps the pudding go down, and the rust flakes added a much needed crunch to the meal. Thank god this was served with four glasses of flavored water to wash down this garbage. You give it an 8/10.",
        inebriation = 1000,
        str_desc = "If the waiter didn't tell you this was Rice Pudding, you have no fucking idea what the hell your looking at. It is a bowl of gunky yet formless mass of the most bland coloration you can think of.  The pudding is confetti'd with flakes of rusted metal shredded by a cheese shredder. If Guy Fieri said this shit is good...",
        time_expir = 7500,
    ),
    EwFood(
    ...
    EwFood(
        id_food = "tomatoicecream",
        alias = ['tomatocream', 'tomatoice', 'icecream'],
        recover_hunger = 20,
        price = 1000,
        str_name = "Tomato Ice Cream",
        vendors = ['Beach Resort'],
        str_eat = "You pick up the ball of frozen tomato and crunch it down, testing your gag reflex from how awful it tastes. There wasn't even any salt or anything to dissolve the bitter taste, and can't ask for any with your retching. This was not your wisest decision.",
        str_desc = "A frozen orb of pulp tomato resting on two leaves of blood cabbage. It's melting already, and will likely taste a lot worse if you don't choke it down now.",
        time_expir = 1500,
    ),
    EwFood(
        id_food = "funpizza",
        ...
        str_name = "Fun Pizza",
        vendors = ['Beach Resort'],
        str_eat = "You didn't actually realize what this was until the bartender brings it out. It's a watermelon slice pizza topped with other healthy fruits. You wouldn't have ordered this expensive piece of shit if you knew what it was in the first place. With a rebellious sigh, you eat the entire thing.",
        str_desc = "https://imgur.com/DT0pd45",
        time_expir = 1,
    ),
    EwFood(
        id_food = "quantumhorderves",
        alias = ['quantumorderves', 'quantumhorderves', 'horderves', 'orderves'],
        recover_hunger = 5000,
        price = 500000,
        str_name = "Quantum Horderves",
        vendors = ['Country Club'],
        str_eat = "You quickly snatch the horderve off the plater as the waiter walks by. You quickly pop the food blob into your mouth, skewer and all. The world slows and time becomes an abstract concept. The material plane are broken down to their atoms, existence becomes a simple puzzle of cause and effect. You don't just taste the horderve, you become one with it, thus one with the universe. You watch the birth and death of the universe and observe the tree timelines merge and die. With a final gulp, you return to your plane of existence. For a moment for contemplate the simplicity of your existence, wondering what your doing has any worth to the grander scale of things. But then the musky after taste hits you. Bleagghh. You should probably stick with the cheese and crackers. ",
        str_desc = "A ball of food stuff skewered with a fancy silver fork. You watch it age like fine wine right before your eyes.",
        time_expir = 1, 
    ),
]
