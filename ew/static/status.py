...
trauma_list = [
    ...
    EwTrauma(  # 18
        ...
        str_trauma_self="Your body is riddled with scars, circled around limbs which dont seem to be reattached correctly.",
        str_trauma="Their body is riddled with scars, circled around limbs which dont seem to be reattached correctly.",
        trauma_class=ewcfg.trauma_class_accuracy,
    ),
    EwTrauma(  # 17
        id_trauma='amateur',
