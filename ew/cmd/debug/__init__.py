...
cmd_map = {
    ...
    ewcfg.cmd_scrutinize: debug.scrutinize,
    ...
    ewcfg.cmd_prefix + debug.cmd_debug9: debug.debug9,

    ewcfg.cmd_changegamestate: debug.change_gamestate,
    ewcfg.cmd_display_states: debug.display_states,
