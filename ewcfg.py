...
cosmetic_items_list = [
    ...
    EwCosmeticItem(
		id_cosmetic = "gasmask",
		str_name = "Gas Mask",
		str_desc = "A dysfunctional cold war era gas mask that full encapsulates the head.",
		rarity = rarity_plebeian,
		acquisition = acquisition_smelting,
		is_hat = True,
	),
    ...
    EwCosmeticItem(
		...
		str_name = "VR Headset",
		str_desc = "Endless War now in stunning VR! Look much cooler as you try to make you're way around a slightly more canny landscape.",
		rarity = rarity_plebeian,
		acquisition = acquisition_smelting,
		is_hat = True,
	),
    ...
    EwCosmeticItem(
		...
		str_desc = "A leather hat with a neat pair of goggles on it. Perfect for a unfortunate circumnavigation of the world.",
		rarity = rarity_plebeian,
		acquisition = acquisition_smelting,
		is_hat = True,
	),
