...
help_responses = {
	"mining":"Mining is the primary way to gain slime in **ENDLESS WAR**. When you mine, you use up around 0.5% of your total hunger. The more slime you mine for, the higher your level gets, and the higher your level gets, the more slime you gain with every !mine command, resulting in exponential gains. **JUVENILES** can mine any time they like, but **ROWDYS** and **KILLERS** are restricted to mining during the day (8AM-6PM) and night (8PM-6AM), respectively.",
	...
	"capturing":"Capturing districts is the primary objective of **ENDLESS WAR**. If you reach **level 10** (done by gaining at least 10,000 slime), you are able to capture districts and generate slime for your team's **Kingpin**. The rate at which you capture a district is determined by various factors. If more **people** are capturing a district, that district will take **less** time to capture. The **property class** of that district will also increase capture time, with S class districts taking **more** time to capture than C class districts. Districts will take **less** time to capture if they are nearby **friendly** districts, and **more** time to capture if they are nearby **enemy** districts. Districts will have their capture progress **decay** over time, but if a captured district is **fully surrounded** by friendly districts (example: Assault Flats Beach is surrounded by Vagrant's Corner and New New Yonkers), then it will **not** decay. Inversely, districts will decay **faster** if they are next to **enemy** districts. **DECAPTURING** (lowering an enemy's capture progress on districts they control) and **RENEWING** (increasing capture progress on districts your team currently controls) can also be done, but only if that district is **not** fully surrounded. **JUVIE'S ROW**, **ROWDY ROUGHHOUSE**, and **COP KILLTOWN** are gang bases, and thus cannot be captured, nor do they decay.",
	"dojo":"",
	"bleeding":"bleeding is bad!",
	"scavenging":"scavenging, etc. etc.",
	"farming":"**Farming** is an alternative way to gain slime, accessible only by **JUVENILES**. Currently, it is done by planting **poudrins** on a farm with the !sow command. After about 12 in-game hours (3 hours in real life), you can use !reap to gain 160,000 slime, with a 1/3 chance to gain a poudrin. If you do gain a poudrin, you also have 1/3 chance to gain a second poudrin, and so on with subsequent poudrins. If your poudrin plant is left alone for too long (around 2 in-game days), it will **die out**. In addition to slime, farming also provides you with various **crops**.",
	"slimeoids":"",
	"transportation":"There are various methods of transportation within the city, the quickest and most efficient of them being **The Subway System**. Trains can be boarded with !board or !embark, and to board specific trains, you can add your destination to the command (example: To board the red line to Cratersville, use !board redtocv). To exit, you can use !disembark. **The Ferry** and **The Blimp** can also be used as a method of transportation, though they take longer to arrive at their destinations than the trains do.",
	"scouting":"",
	"offline":""
}
