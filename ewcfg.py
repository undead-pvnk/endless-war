...
help_responses_ordered_keys = [
	...
	"sap", weapon_id_revolver, weapon_id_dualpistols, weapon_id_shotgun, weapon_id_rifle, 
	weapon_id_smg, weapon_id_bat, weapon_id_brassknuckles, weapon_id_katana, weapon_id_broadsword, 
	weapon_id_nunchucks, weapon_id_scythe, weapon_id_yoyo, weapon_id_umbrella, weapon_id_knives, 
	weapon_id_molotov, weapon_id_grenades, weapon_id_garrote, weapon_id_minigun, weapon_id_dclaw,
]
