...
cmd_decline = cmd_prefix + 'decline'
cmd_bid = cmd_prefix + 'bid'
cmd_call = cmd_prefix + 'call'
cmd_pass = cmd_prefix + 'pass'
cmd_play = cmd_prefix + 'play'
cmd_hearts = cmd_prefix + 'hearts'
cmd_slugs = cmd_prefix + 'slugs'
cmd_hats = cmd_prefix + 'hats'
cmd_shields = cmd_prefix + 'shields'
cmd_grand = cmd_prefix + 'grand'
cmd_null = cmd_prefix + 'null'
cmd_take = cmd_prefix + 'take'
cmd_hand = cmd_prefix + 'hand'
cmd_choose = cmd_prefix + 'choose'
