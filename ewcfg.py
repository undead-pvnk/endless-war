...
poi_neighbors = {
	...
	poi_id_oldnewyonkers : (poi_id_assaultflatsbeachresort, poi_id_vagrantscorner, poi_id_smogsburg, poi_id_littlechernobyl, poi_id_brawlden, poi_id_newnewyonkers),
	...
	poi_id_assaultflatsbeachresort : (poi_id_vagrantscorner, poi_id_oldnewyonkers, poi_id_newnewyonkers),
