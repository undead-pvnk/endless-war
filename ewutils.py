...
def is_otp(user_data):
	return user_data.poi in [ewcfg.poi_id_thesewers, ewcfg.poi_id_juviesrow, ewcfg.poi_id_copkilltown, ewcfg.poi_id_rowdyroughhouse] and user_data.poi[:3] != ewcfg.poi_id_apt
